...
---|---|---|--- | --- | ---
1 | Two Sum | Easy | [Solution](leetcode/1.%20Two%20Sum) | TC - O(N*N) SC - O(1) | 2
2 | Add Two Numbers | Medium | [Solution](leetcode/2.%20Add%20Two%20Numbers) | TC - O(N) SC - O(1) | 
3 | Longest Substring Without Repeating Characters | Medium | [Solution](leetcode/3.%20Longest%20Substring%20Without%20Repeating%20Characters) | TC- O(N*N*N) SC-O(N) | 
4 | Median of Two Sorted Arrays | Hard | [Solution](leetcode/4.%20Median%20of%20Two%20Sorted%20Arrays) | TC: O(nlogn) SC-O(1) | 
5 | Longest Palindromic Substring | Medium | [Solution](https://github.com/kumarvoman/LeetCode/blob/main/5.%20Longest%20Palindromic%20Substring) | TC-O(N*N*N) SC-O(1) | 
